...
class AudioDownloadService(private val context: Context) {
    ...
    private fun globalAyahNumber(surah: Int, ayah: Int): Int {
        // BUGFIX (v5.3.1): see AudioController.AYAH_COUNTS for the full
        // explanation — this table was missing Surah 23 (118 ayahs), which
        // shifted every surah from 23 onward and made this method resolve
        // to the wrong absolute ayah index, so offline downloads saved the
        // wrong ayah's audio file under the requested surah/ayah's filename.
        var sum = 0
